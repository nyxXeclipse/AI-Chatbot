...
async function generateResponse(aiChatBox) {
  ...
  try {
    ...
    text.innerHTML = "⚠️ Something went wrong.";
    console.error(error);
  } finally {
...
function handlechatResponse(userMessage) {
  ...
  let html = `<img src="Images/user.png" alt="User" id="userImage">
  ...
  setTimeout(() => {
    let html = `<img src="Images/ai.png" alt="AI" id="aiImage">
  <div class="ai-chat-area">
    <div class="loader">
      <dotlottie-wc
        src="https://lottie.host/5828d967-3f13-4fc1-b48a-a3a133c7b76c/o7yfetOjGF.lottie"
